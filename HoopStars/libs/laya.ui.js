! function(t, i, e) {
    ...
    var T = function() {
        ...
        P = (function(t) {
            ...
            n(i, "laya.ui.UIEvent", _), i.SHOW_TIP = "showtip", i.HIDE_TIP = "hidetip";
        }(), function(t) {
            function i() {
            ...
            return s.destroy = function() {
                ...
                return s <= 0 && (s = 1), n <= 0 && (n = 1), t.$_GID || (t.$_GID = M.getGID()),
                    h && h._getSource() || (h = k.createFromTexture(t, i, e, s, n)), h;
            }, i;
        }(d)),
        Y = function(t) {
            function i() {
        ...
        N = function(t) {
            ...
            return s.destroy = function(i) {
                ...
                if (i)
                    for (var e = 0, s = i.length; e < s; e++) i[e].exe(this);
            }, s._sizeChanged = function() {
                isNaN(this._anchorX) || (this.pivotX = this.anchorX * this.width), isNaN(this._anchorY) || (this.pivotY = this.anchorY * this.height),
                    this.event("resize");
            }, s._getWidget = function() {
        ...
        J = function(t) {
            ...
            return l.getLocalDateString = function(t) {
                ...
                var t, i, s = !1;
                (t = "horizontal" == e.stage.screenMode ? r.height % 9 : r.width % 9, r.onAndroid && 0 == t) && (i = "horizontal" == e.stage.screenMode ? r.width : r.height, -1 != [2280, 2160, 2244, 3120, 2248, 2340, 2310].indexOf(i) && (s = !0));
                ...
                return !r.onMiniGame && !r.onBDMiniGame || r.onAndroid || !n && !h || (s = !0),
                    s;
                ...
                o = function(t) {
                    ...
                    return e.init = function(t, i, e) {
                        if (this.titleLabel ? this.titleLabel.text = t.title : (this.titleLabel = this.onCreateLabel(t.title, this, 32, "#3d3939"),
                            ...
                            for (s = 0,
                                n = this.gameListBox._children.length; s < n; s++)(h = this.gameListBox._children[s]).init(t.gameList[s], i, e);
                        else {
        ...
        Z = function(t) {
            ...
            return e.imps(s, {
                ...
                if (-1 != e) {
                    var s, n = t;
                    this.removeChild(n);
                    for (var h = e + 1, o = this._items.length; h < o; h++) {
                        var r = this._items[h];
                        r.name = "item" + (h - 1), i && ("horizontal" == this._direction ? r.x -= n.width + this._space : r.y -= n.height + this._space);
                    }
        ...
        st = function(t) {
            ...
            return e.imps(s, {
                ...
                for (var u = t; u < e; u++)
                    for (var _ = 0; _ < i; _++)(n = a && a.length ? a.pop() : this.createItem()).x = (this._isVertical ? _ : u) * h - s._x,
        ...
        at = (function(t) {
            ...
            return n(i, "laya.ui.VScrollBar", F), i;
        }()),
        lt = function(t) {
            function i() {
                i.__super.call(this);
            }
            return n(i, "laya.ui.VSlider", j), i;
        }(),
        ct = function(t) {
            function i() {
                i.__super.call(this);
            }
            return n(i, "laya.ui.HScrollBar", t), i.prototype.initialize = function() {
        ...
        ut = function(t) {
            ...
            return n(i, "laya.ui.HSlider", j), i;
        }(),
        _t = function(t) {
            function i() {
                i.__super.call(this);
        ...
        dt = function(t) {
            ...
            return n(i, "laya.ui.RadioGroup", Z), i.prototype.createItem = function(t, i) {
                return new ot(t, i);
            }, i;
        }(),
        ft = function(t) {
        ...
        pt = function(t) {
            ...
            return n(i, "laya.ui.Tab", Z), i.prototype.createItem = function(t, i) {
                return new E(t, i);
            }, i;
        }();
    e.__init([J, N]);
